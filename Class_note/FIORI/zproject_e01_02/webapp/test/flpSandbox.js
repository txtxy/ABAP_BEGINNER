		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#C05zprojecte0102-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"C05zprojecte0102-display": {
								"semanticObject": "C05zprojecte0102",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=C05.zprojecte0102",
									"url": sap.ui.require.toUrl("C05/zprojecte0102")
								}
							}
						}
					}
