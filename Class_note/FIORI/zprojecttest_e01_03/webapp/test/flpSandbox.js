		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zprojectteste0103-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste0103-display": {
								"semanticObject": "zprojectteste0103",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste0103",
									"url": sap.ui.require.toUrl("zprojectteste0103")
								}
							}
						}
					}
