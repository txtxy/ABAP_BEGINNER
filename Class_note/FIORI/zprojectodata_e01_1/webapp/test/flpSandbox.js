		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zprojectodatae011-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectodatae011-display": {
								"semanticObject": "zprojectodatae011",
								"action": "display",
								"description": "Odata Fiori Application",
								"title": "Application Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectodatae011",
									"url": sap.ui.require.toUrl("zprojectodatae011")
								}
							}
						}
					}
