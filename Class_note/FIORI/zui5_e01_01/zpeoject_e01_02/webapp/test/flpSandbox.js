		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zpeojecte0102-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpeojecte0102-display": {
								"semanticObject": "zpeojecte0102",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpeojecte0102",
									"url": sap.ui.require.toUrl("zpeojecte0102")
								}
							}
						}
					}
