		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zprojectodatae0101-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectodatae0101-display": {
								"semanticObject": "zprojectodatae0101",
								"action": "display",
								"description": "A Fiori application For Odata Service",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectodatae0101",
									"url": sap.ui.require.toUrl("zprojectodatae0101")
								}
							}
						}
					}
