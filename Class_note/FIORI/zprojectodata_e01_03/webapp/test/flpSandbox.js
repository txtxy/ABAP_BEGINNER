		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "North Wind",
									"targetURL": "#ntzprojectodatae0103-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntzprojectodatae0103-display": {
								"semanticObject": "ntzprojectodatae0103",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nt.zprojectodatae0103",
									"url": sap.ui.require.toUrl("nt/zprojectodatae0103")
								}
							}
						}
					}
