		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exprograme01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exprograme01-display": {
								"semanticObject": "exprograme01",
								"action": "display",
								"description": "Exam",
								"title": "App Title",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exprograme01",
									"url": sap.ui.require.toUrl("exprograme01")
								}
							}
						}
					}
